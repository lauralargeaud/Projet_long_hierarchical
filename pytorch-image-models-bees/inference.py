...
def main():
    ...
    if args.conf_matrix and args.csv_tree:
        ...
        if args.logicseg:
            ...
            save_confusion_matrix(cm, output_filename, classes_labels, output_folder=args.results_dir)
            save_confusion_matrix(cm_normalized, output_filename_norm, classes_labels, output_folder=args.results_dir)
            df = save_metrics(cm, output_folder=args.results_dir, output_filename="metrics_branches.csv", classes=classes_labels, hierarchy_name="branches")
            ...
            for hauteur in range(h):
                ...
                save_confusion_matrix(cm_normalized, output_filename, labels_par_hauteur[hauteur], output_folder=args.results_dir)
                save_confusion_matrix(cm_normalized, output_filename_norm, labels_par_hauteur[hauteur], output_folder=args.results_dir)
                next_df = save_metrics(cm, output_folder=args.results_dir, output_filename=f"metrics_{header_list[hauteur]}.csv", classes=labels_par_hauteur[hauteur], hierarchy_name=header_list[hauteur])
