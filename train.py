...
group.add_argument('--crule-loss-weight', action='store_true', type=float, default=0.2,
                   help='Set the weight of the Closs.')
group.add_argument('--drule-loss-weight', action='store_true', type=float, default=0.2,
                   help='Set the weight of the Dloss.')
group.add_argument('--erule-loss-weight', action='store_true', type=float, default=0.2,
                   help='Set the weight of the Eloss.')
group.add_argument('--bce-loss-weight', action='store_true', type=float, default=1,
